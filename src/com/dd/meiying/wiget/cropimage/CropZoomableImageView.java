 ...
 */
public class CropZoomableImageView extends ImageView implements
				...
				new GestureDetector.SimpleOnGestureListener() {
					...
					public boolean onDoubleTap(MotionEvent e) {
						...
						if (getScale() < SCALE_MID) {
							CropZoomableImageView.this.postDelayed(
	...
	public Bitmap clip() {
		...
		mBitmap = Bitmap.createBitmap(bitmap, mHorizontalPadding,
