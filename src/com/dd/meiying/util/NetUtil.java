...
public class NetUtil {
	...
	public static boolean isNetworkAvailable() {
		Context con = MeiyingAplication.CONTEXT;
	...
	public static boolean isGPSAvailable() {
		boolean result;
		LocationManager locationManager = (LocationManager) MeiyingAplication.CONTEXT
	...
	public static boolean isWifiAvailable() {
		WifiManager wm = (WifiManager) MeiyingAplication.CONTEXT
